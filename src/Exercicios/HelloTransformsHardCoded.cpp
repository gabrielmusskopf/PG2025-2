...
int setupGeometry()
{
	...
	GLfloat vertices[] = {
		// x   y     z   r   g    b
		// T0
		-0.5 * 400 + 400,  0.5 * 400 + 300, 0.0, 1.0, 0.0, 0.0,    // v0
		-0.5 * 400 + 400, -0.5 * 400 + 300, 0.0, 0.0, 1.0, 0.0,    // v1
		 0.0 * 400 + 400,  0.0 * 400 + 300, 0.0, 0.0, 0.0, 1.0,	   // v2
		// T1
        0.0 * 400 + 400,   0.0 * 400 + 300, 0.0, 1.0, 1.0, 0.0,    //v3
        0.5 * 400 + 400,  -0.5 * 400 + 300, 0.0, 0.0, 1.0, 1.0,    //v4
        0.5 * 400 + 400,   0.5 * 400 + 300, 0.0, 1.0, 0.0, 1.0	   //v5      
